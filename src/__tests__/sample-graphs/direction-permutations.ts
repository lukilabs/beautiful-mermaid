...
export const DIRECTION_PERMUTATION_SAMPLES: SampleGraph[] = [
  {
    ...
    expectedSubgraphAspect: [{ subgraph: 'TB Stack', taller: true }],
    source: `graph LR
  ...
  },
  {
    ...
    expectedAxisOrder: [
      { axis: 'x', items: ['l1', 'l2', 'l3'] },
      { axis: 'y', items: ['r3', 'r2', 'r1'] },
    ],
    expectedSubgraphAspect: [
      { subgraph: 'LR pipeline', wider: true },
      { subgraph: 'BT stack', taller: true },
    ],
    source: `graph TD
  ...
  },
  {
    ...
    expectedSubgraphAspect: [{ subgraph: 'LR Middle', wider: true }],
    expectedEdgesReachTargets: [{ source: 'src', target: 'a' }],
    source: `graph TB
  ...
  },
  {
    ...
    expectedAxisOrder: [
      { axis: 'x', items: ['rlC', 'rlB', 'rlA'] },
      { axis: 'y', items: ['btC', 'btB', 'btA'] },
    ],
    expectedSubgraphAspect: [
      { subgraph: 'RL row', wider: true },
      { subgraph: 'BT stack', taller: true },
    ],
    source: `graph TB
  ...
  },
  {
    ...
    expectedNesting: [
      ['Outer LR', 'Inner TB', 'Deeper LR', 'Deepest TB', 'a'],
    ],
    source: `graph LR
  ...
  },
  {
    ...
    expectedNesting: [
      ['Outer TB', 'Inner LR', 'Deeper TB', 'Deepest LR', 'a'],
    ],
    source: `graph TB
  ...
  },
  {
    ...
    expectedSubgraphAspect: [{ subgraph: 'LR Row', wider: true }],
    containment: { a: 'LR Row', b: 'LR Row', c: 'LR Row' },
    source: `graph TD
      subgraph row [LR Row]
        direction LR
        a --> b --> c
